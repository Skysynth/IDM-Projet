 ...
 * @generated
 */
public class SchemaTableAlgoSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SchemaTableAlgoPackage.SCHEMA_TABLE: {
			SchemaTable schemaTable = (SchemaTable) theEObject;
			T result = caseSchemaTable(schemaTable);
			if (result == null)
		...
		case SchemaTableAlgoPackage.COLONNE: {
		...
		case SchemaTableAlgoPackage.COLONNE_SPECIALE: {
			ColonneSpeciale colonneSpeciale = (ColonneSpeciale) theEObject;
			T result = caseColonneSpeciale(colonneSpeciale);
			if (result == null)
				result = caseColonne(colonneSpeciale);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SchemaTableAlgoPackage.COLONNE_NORMAL: {
			ColonneNormal colonneNormal = (ColonneNormal) theEObject;
			T result = caseColonneNormal(colonneNormal);
			if (result == null)
				result = caseColonne(colonneNormal);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Schema Table</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Schema Table</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSchemaTable(SchemaTable object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Colonne Speciale</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Colonne Speciale</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColonneSpeciale(ColonneSpeciale object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Colonne Normal</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Colonne Normal</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColonneNormal(ColonneNormal object) {
		return null;
	}
