...
/**
 * This is the item provider adapter for a {@link fr.l127.RessourceGraphique.RacineCarree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RacineCarreeItemProvider extends BlocItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RacineCarreeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RacineCarree"));
	}
	...
	public String getText(Object object) {
		String label = ((RacineCarree) object).getNom();
		return label == null || label.length() == 0 ? getString("_UI_RacineCarree_type")
				: getString("_UI_RacineCarree_type") + " " + label;
	}
