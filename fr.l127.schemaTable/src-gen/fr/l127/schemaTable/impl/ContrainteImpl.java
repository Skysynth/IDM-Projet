 ...
 * </p>
 * <ul>
 *   <li>{@link fr.l127.schemaTable.impl.ContrainteImpl#getNom <em>Nom</em>}</li>
 *   <li>{@link fr.l127.schemaTable.impl.ContrainteImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContrainteImpl extends MinimalEObjectImpl.Container implements Contrainte {
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaTablePackage.CONTRAINTE__NOM, oldNom, nom));
	}
	...
	public EList<String> getArgs() {
		if (args == null) {
			args = new EDataTypeUniqueEList<String>(String.class, this, SchemaTablePackage.CONTRAINTE__ARGS);
		}
		return args;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SchemaTablePackage.CONTRAINTE__NOM:
			return getNom();
		case SchemaTablePackage.CONTRAINTE__ARGS:
			return getArgs();
		}
