 ...
 * </p>
 * <ul>
 *   <li>{@link fr.l127.schemaTable.impl.ColonneImpl#getId <em>Id</em>}</li>
 *   <li>{@link fr.l127.schemaTable.impl.ColonneImpl#getTypeColonne <em>Type Colonne</em>}</li>
 *   <li>{@link fr.l127.schemaTable.impl.ColonneImpl#getContrainte <em>Contrainte</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ColonneImpl extends MinimalEObjectImpl.Container implements Colonne {
	...
	public void setTypeColonne(TypeColonne newTypeColonne) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaTablePackage.COLONNE__TYPE_COLONNE,
	...
	public NotificationChain basicSetContrainte(Contrainte newContrainte, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SchemaTablePackage.COLONNE__CONTRAINTE, oldContrainte, newContrainte);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContrainte != contrainte) {
			...
			if (contrainte != null)
				msgs = ((InternalEObject) contrainte).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SchemaTablePackage.COLONNE__CONTRAINTE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaTablePackage.COLONNE__CONTRAINTE, newContrainte,
					newContrainte));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SchemaTablePackage.COLONNE__CONTRAINTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case SchemaTablePackage.COLONNE__ID:
			return getId();
		case SchemaTablePackage.COLONNE__TYPE_COLONNE:
