...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Racine Carree</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.l127.RessourceGraphique.impl.RacineCarreeImpl#getEntree <em>Entree</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RacineCarreeImpl extends BlocImpl implements RacineCarree {
	/**
	...
	protected EClass eStaticClass() {
		return RessourceGraphiquePackage.Literals.RACINE_CARREE;
	}
			...
			if (entree != oldEntree) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RessourceGraphiquePackage.RACINE_CARREE__ENTREE, oldEntree, entree));
			}
		}
		return entree;
	}
	...
	public void setEntree(Bloc newEntree) {
		...
		entree = newEntree;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RessourceGraphiquePackage.RACINE_CARREE__ENTREE,
					oldEntree, entree));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RessourceGraphiquePackage.RACINE_CARREE__ENTREE:
			if (resolve)
				return getEntree();
