...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sinus</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.l127.ressourceGraphique.impl.SinusImpl#getEntree <em>Entree</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SinusImpl extends BlocImpl implements Sinus {
	/**
	...
	protected EClass eStaticClass() {
		return RessourceGraphiquePackage.Literals.SINUS;
	}
		...
		if (entree != null && entree.eIsProxy()) {
			...
			if (entree != oldEntree) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RessourceGraphiquePackage.SINUS__ENTREE,
							oldEntree, entree));
			}
		}
		return entree;
	...
	public void setEntree(Bloc newEntree) {
		...
		entree = newEntree;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RessourceGraphiquePackage.SINUS__ENTREE, oldEntree,
					entree));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RessourceGraphiquePackage.SINUS__ENTREE:
			if (resolve)
				return getEntree();
